...
import { Printer, ArrowLeft, RotateCcw, ShieldCheck } from "lucide-react";
...
export default function JobOrderDetail() {
  ...
  async function load() {
    ...
    setWarrantyForm({
      ...
      starts_on: res.warranty?.starts_on || "",
      ends_on: res.warranty?.ends_on || ""
    });
  }
  ...
  function formFromJobOrder(jobOrder) {
    return {
      ...
      expected_completion: jobOrder.expected_completion || ""
    };
  }
    ...
    <div className="max-w-3xl">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mt-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to={`/admin/job-orders/${id}/print`} className="btn-secondary"><Printer size={16} /> Print</Link>
        </div>
      </div>
